...
import com.example.floatingflavors.app.feature.user.presentation.booking.booking_checkout.components.CheckoutBlueSoft
import com.example.floatingflavors.app.feature.user.presentation.booking.booking_checkout.components.CheckoutTextMuted

@Composable
fun CheckoutAddressCard(
    address: AddressCheckoutDto,
    selected: Boolean,
    onClick: () -> Unit
) {
    Card(
